...
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |   ~  |  1   |  2   |  3   |  F5  |  F6  |  F7  |  F8  |  F9  |   [  |   ]  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  Del |  4   |  5   |  6   |   4  |   5  |  `   |   -  |   =  |   (  |   )  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  7   |  8   |   9  |   9  |   0  | \    |ISO # |ISO / |Pg Up |Pg Dn |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |   0  |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
    KC_TILD,  KC_1,    KC_2,    KC_3,  KC_F5,   KC_F6,  KC_F7,    KC_F8,   KC_F9,   KC_LBRC, KC_RBRC,   KC_BSPC,   
    KC_DEL,   KC_4,    KC_5,    KC_6,  KC_4,    KC_5,   KC_GRV,   KC_MINS, KC_EQL,  KC_LPRN, KC_RPRN,   KC_BSPC, 
    _______,  KC_7,    KC_8,    KC_9,  KC_9,    KC_0,   KC_BSLS,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
