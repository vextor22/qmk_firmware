...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,  KC_GRV,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC,   KC_BSPC, 
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_BSLS,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
